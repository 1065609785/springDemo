...
public class TestController {
	...
	@ApiOperation(value = "测试创建用户", notes = "根据User对象创建用户")
	...
	@ApiOperation(value = "测试获取用户", notes = "通过id获取用户信息")
	@ApiImplicitParams({
	...
	@ApiOperation(value = "测试更新用户", notes = "全量更新")
	@ApiImplicitParams({ @ApiImplicitParam(dataType = "UserInfo", name = "userInfo", value = "用户信息", required = true) })
	...
	@ApiOperation(value = "测试删除用户", notes = "通过id删除用户信息")
	@ApiImplicitParams({
			@ApiImplicitParam(dataType = "Long", name = "id", value = "用户id", required = true, paramType = "path") })
